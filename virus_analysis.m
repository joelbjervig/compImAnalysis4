...
% [glcm,I_co] = graycomatrix(I,'Offset',[1 0]*10); %[glcm,I_co] = graycomatrix(I,'Offset',[1 0; -1 1;-1 0;-1 -1]*10);
% figure
% imshow(rescale(I_co))
...
for i=1:length(cutouts)
    [glcm,I_co] = graycomatrix(cell2mat(cutouts(i)),'Offset',[1 0]*10);%; -1 1;-1 0;-1 -1
